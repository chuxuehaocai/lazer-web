...
const copy = {
  zh: {
    documentTitle: 'Lazer — 让音乐回到你的手中', documentDescription: 'Lazer 是一款安静、精致的开源跨平台音乐播放器，支持 Windows 与 Android。',
    experience: '体验', preview: '预览', downloads: '下载', github: 'GitHub', latest: '最新版本',
    eyebrow: '开源跨平台播放器', heroTitle: <>让音乐<br /><em>回到你的手中。</em></>,
    heroLede: 'Lazer 是一款适用于 Windows 与 Android 的安静而精致的音乐播放器。找到你的声音，沉浸在当下，让每张专辑都拥有自己的氛围。',
    ...
    madeTitle: '为聆听而生', madeBody: '专注的控制、流动的专辑色彩，以及不打扰音乐的视觉噪音。',
    expressiveTitle: '安静地表达', expressiveBody: '每个界面都从当前专辑汲取灵感，同时保持易于浏览。',
    openTitle: '生来开放', openBody: '在开放环境中构建，版本可查看、安装，也可以由你塑造。',
    footer: '一款支持 Windows 与 Android、为专注聆听而设计的开源音乐播放器。', light: '切换到浅色模式', dark: '切换到深色模式', language: '切换到 English',
  ...
  en: {
    documentTitle: 'Lazer — Music that feels like yours', documentDescription: 'Lazer is a calm, beautifully crafted open source music player for Windows and Android.',
    experience: 'Experience', preview: 'Preview', downloads: 'Download', github: 'GitHub', latest: 'Latest release',
    eyebrow: 'Open source cross-platform player', heroTitle: <>Music that feels<br /><em>like yours.</em></>,
    heroLede: 'Lazer is a calm, beautifully crafted music player for Windows and Android. Find your sound, tune into the moment, and let every album have its own atmosphere.',
    ...
    madeTitle: 'Made for listening', madeBody: 'Focused controls, fluid album color, and no visual noise between you and the music.',
    ...
    footer: 'An open source music player for considered listening on Windows and Android.', light: 'Switch to light mode', dark: 'Switch to dark mode', language: '切换到中文',
